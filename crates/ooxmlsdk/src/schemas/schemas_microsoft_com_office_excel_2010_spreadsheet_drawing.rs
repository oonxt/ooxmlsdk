...
#[derive(Clone, Debug, Default, hard_xml::XmlWrite, hard_xml::XmlRead)]
#[xml(tag = "xdr14:cNvContentPartPr")]
...
pub struct ApplicationNonVisualDrawingProperties {
    ...
    #[xml(attr = "fPublished")]
    pub published_flag: Option<bool>,
}
