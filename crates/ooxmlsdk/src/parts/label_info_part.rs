...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2020/02/relationships/classificationlabels";
#[derive(Clone, Debug, Default)]
pub struct LabelInfoPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_2020_mip_label_metadata::ClassificationLabelList,
}
impl LabelInfoPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_2020_mip_label_metadata::ClassificationLabelList::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let label_info_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "docMetadata"),
        );
        if !label_info_part_dir_path.is_empty()
            && !entry_set.contains(&label_info_part_dir_path)
        {
            zip.add_directory(
                &label_info_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(label_info_part_dir_path);
        }
