...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/tableSingleCells";
#[derive(Clone, Debug, Default)]
pub struct SingleCellTablePart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_openxmlformats_org_spreadsheetml_2006_main::SingleXmlCells,
}
impl SingleCellTablePart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_spreadsheetml_2006_main::SingleXmlCells::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let single_cell_table_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../tables"),
        );
        if !single_cell_table_part_dir_path.is_empty()
            && !entry_set.contains(&single_cell_table_part_dir_path)
        {
            zip.add_directory(
                &single_cell_table_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(single_cell_table_part_dir_path);
        }
