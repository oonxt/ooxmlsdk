...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/ctrlProp";
#[derive(Clone, Debug, Default)]
pub struct ControlPropertiesPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_spreadsheetml_2009_9_main::FormControlProperties,
}
impl ControlPropertiesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_spreadsheetml_2009_9_main::FormControlProperties::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let control_properties_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../ctrlProps"),
        );
        if !control_properties_part_dir_path.is_empty()
            && !entry_set.contains(&control_properties_part_dir_path)
        {
            zip.add_directory(
                &control_properties_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(control_properties_part_dir_path);
        }
