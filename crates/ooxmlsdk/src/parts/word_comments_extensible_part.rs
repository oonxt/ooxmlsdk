...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2018/08/relationships/commentsExtensible";
#[derive(Clone, Debug, Default)]
pub struct WordCommentsExtensiblePart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_word_2018_wordml_cex::CommentsExtensible,
}
impl WordCommentsExtensiblePart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_word_2018_wordml_cex::CommentsExtensible::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let word_comments_extensible_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !word_comments_extensible_part_dir_path.is_empty()
            && !entry_set.contains(&word_comments_extensible_part_dir_path)
        {
            zip.add_directory(
                &word_comments_extensible_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(word_comments_extensible_part_dir_path);
        }
