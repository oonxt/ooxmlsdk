...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesMaster";
...
impl NotesMasterPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "notesMasters/");
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::NotesMaster::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let notes_master_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "notesMasters"),
        );
        if !notes_master_part_dir_path.is_empty()
            && !entry_set.contains(&notes_master_part_dir_path)
        {
            zip.add_directory(
                &notes_master_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(notes_master_part_dir_path);
        }
