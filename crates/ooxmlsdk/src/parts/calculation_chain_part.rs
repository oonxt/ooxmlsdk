...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/calcChain";
#[derive(Clone, Debug, Default)]
pub struct CalculationChainPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_openxmlformats_org_spreadsheetml_2006_main::CalculationChain,
}
impl CalculationChainPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_spreadsheetml_2006_main::CalculationChain::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let calculation_chain_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !calculation_chain_part_dir_path.is_empty()
            && !entry_set.contains(&calculation_chain_part_dir_path)
        {
            zip.add_directory(
                &calculation_chain_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(calculation_chain_part_dir_path);
        }
