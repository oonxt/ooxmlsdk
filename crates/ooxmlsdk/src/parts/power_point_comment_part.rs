...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2018/10/relationships/comments";
#[derive(Clone, Debug, Default)]
pub struct PowerPointCommentPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_powerpoint_2018_8_main::CommentList,
}
impl PowerPointCommentPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_powerpoint_2018_8_main::CommentList::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let power_point_comment_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../comments"),
        );
        if !power_point_comment_part_dir_path.is_empty()
            && !entry_set.contains(&power_point_comment_part_dir_path)
        {
            zip.add_directory(
                &power_point_comment_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(power_point_comment_part_dir_path);
        }
