...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/footnotes";
...
pub struct FootnotesPart {
    ...
    pub root_element: crate::schemas::schemas_openxmlformats_org_wordprocessingml_2006_main::Footnotes,
...
impl FootnotesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_wordprocessingml_2006_main::Footnotes::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let footnotes_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !footnotes_part_dir_path.is_empty()
            && !entry_set.contains(&footnotes_part_dir_path)
        {
            zip.add_directory(
                &footnotes_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(footnotes_part_dir_path);
        }
