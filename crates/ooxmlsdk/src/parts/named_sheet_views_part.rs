...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2019/04/relationships/namedSheetView";
...
impl NamedSheetViewsPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_spreadsheetml_2019_namedsheetviews::NamedSheetViews::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let named_sheet_views_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../namedSheetViews"),
        );
        if !named_sheet_views_part_dir_path.is_empty()
            && !entry_set.contains(&named_sheet_views_part_dir_path)
        {
            zip.add_directory(
                &named_sheet_views_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(named_sheet_views_part_dir_path);
        }
