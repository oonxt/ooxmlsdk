...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/diagramData";
...
pub struct DiagramDataPart {
    ...
    pub root_element: crate::schemas::schemas_openxmlformats_org_drawingml_2006_diagram::DataModelRoot,
...
impl DiagramDataPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_drawingml_2006_diagram::DataModelRoot::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let diagram_data_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../graphics"),
        );
        if !diagram_data_part_dir_path.is_empty()
            && !entry_set.contains(&diagram_data_part_dir_path)
        {
            zip.add_directory(
                &diagram_data_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(diagram_data_part_dir_path);
        }
