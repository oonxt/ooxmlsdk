...
pub struct SlideCommentsPart {
    ...
    pub root_element: crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::CommentList,
}
impl SlideCommentsPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::CommentList::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let slide_comments_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../comments"),
        );
        if !slide_comments_part_dir_path.is_empty()
            && !entry_set.contains(&slide_comments_part_dir_path)
        {
            zip.add_directory(
                &slide_comments_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(slide_comments_part_dir_path);
        }
