...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/pivotCacheRecords";
#[derive(Clone, Debug, Default)]
pub struct PivotTableCacheRecordsPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_openxmlformats_org_spreadsheetml_2006_main::PivotCacheRecords,
}
impl PivotTableCacheRecordsPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_spreadsheetml_2006_main::PivotCacheRecords::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let pivot_table_cache_records_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !pivot_table_cache_records_part_dir_path.is_empty()
            && !entry_set.contains(&pivot_table_cache_records_part_dir_path)
        {
            zip.add_directory(
                &pivot_table_cache_records_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(pivot_table_cache_records_part_dir_path);
        }
