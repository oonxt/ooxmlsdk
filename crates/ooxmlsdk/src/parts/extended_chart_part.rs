...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2014/relationships/chartEx";
...
impl ExtendedChartPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "extendedCharts/");
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_drawing_2014_chartex::ChartSpace::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let extended_chart_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "extendedCharts"),
        );
        if !extended_chart_part_dir_path.is_empty()
            && !entry_set.contains(&extended_chart_part_dir_path)
        {
            zip.add_directory(
                &extended_chart_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(extended_chart_part_dir_path);
        }
