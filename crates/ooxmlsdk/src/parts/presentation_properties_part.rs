...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/presProps";
#[derive(Clone, Debug, Default)]
pub struct PresentationPropertiesPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::PresentationProperties,
}
impl PresentationPropertiesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::PresentationProperties::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let presentation_properties_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !presentation_properties_part_dir_path.is_empty()
            && !entry_set.contains(&presentation_properties_part_dir_path)
        {
            zip.add_directory(
                &presentation_properties_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(presentation_properties_part_dir_path);
        }
