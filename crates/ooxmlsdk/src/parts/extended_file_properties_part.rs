...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties";
#[derive(Clone, Debug, Default)]
pub struct ExtendedFilePropertiesPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_openxmlformats_org_office_document_2006_extended_properties::Properties,
}
impl ExtendedFilePropertiesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_office_document_2006_extended_properties::Properties::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let extended_file_properties_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "docProps"),
        );
        if !extended_file_properties_part_dir_path.is_empty()
            && !entry_set.contains(&extended_file_properties_part_dir_path)
        {
            zip.add_directory(
                &extended_file_properties_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(extended_file_properties_part_dir_path);
        }
