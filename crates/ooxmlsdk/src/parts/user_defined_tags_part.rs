...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/tags";
...
impl UserDefinedTagsPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::TagList::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let user_defined_tags_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "tags"),
        );
        if !user_defined_tags_part_dir_path.is_empty()
            && !entry_set.contains(&user_defined_tags_part_dir_path)
        {
            zip.add_directory(
                &user_defined_tags_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(user_defined_tags_part_dir_path);
        }
