...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/viewProps";
...
pub struct ViewPropertiesPart {
    ...
    pub root_element: crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::ViewProperties,
...
impl ViewPropertiesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::ViewProperties::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let view_properties_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !view_properties_part_dir_path.is_empty()
            && !entry_set.contains(&view_properties_part_dir_path)
        {
            zip.add_directory(
                &view_properties_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(view_properties_part_dir_path);
        }
