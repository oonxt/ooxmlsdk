...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2017/06/relationships/richStyles";
#[derive(Clone, Debug, Default)]
pub struct RichStylesPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_spreadsheetml_2017_richdata2::RichStylesheet,
}
impl RichStylesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_spreadsheetml_2017_richdata2::RichStylesheet::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let rich_styles_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "richData"),
        );
        if !rich_styles_part_dir_path.is_empty()
            && !entry_set.contains(&rich_styles_part_dir_path)
        {
            zip.add_directory(
                &rich_styles_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(rich_styles_part_dir_path);
        }
