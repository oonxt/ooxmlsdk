...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2011/relationships/chartColorStyle";
#[derive(Clone, Debug, Default)]
pub struct ChartColorStylePart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_drawing_2012_chart_style::ColorStyle,
}
impl ChartColorStylePart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_drawing_2012_chart_style::ColorStyle::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let chart_color_style_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !chart_color_style_part_dir_path.is_empty()
            && !entry_set.contains(&chart_color_style_part_dir_path)
        {
            zip.add_directory(
                &chart_color_style_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(chart_color_style_part_dir_path);
        }
