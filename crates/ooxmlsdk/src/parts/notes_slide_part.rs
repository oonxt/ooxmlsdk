...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesSlide";
...
pub struct NotesSlidePart {
    ...
    >,
    pub notes_master_part: Option<Box<crate::parts::notes_master_part::NotesMasterPart>>,
    pub theme_override_part: Option<
        crate::parts::theme_override_part::ThemeOverridePart,
    >,
    pub slide_part: Option<Box<crate::parts::slide_part::SlidePart>>,
...
impl NotesSlidePart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "../notesSlides/");
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::NotesSlide::from_str(
        ...
        let mut theme_override_part: Option<
            crate::parts::theme_override_part::ThemeOverridePart,
        > = None;
        let mut slide_part: Option<Box<crate::parts::slide_part::SlidePart>> = None;
                ...
                match relationship.r#type.as_str() {
                    ...
                    crate::parts::notes_master_part::RELATIONSHIP_TYPE => {
                        ...
                        notes_master_part = Some(
                            Box::new(crate::parts::notes_master_part::NotesMasterPart::new_from_archive(
                                &child_parent_path,
                                &target_path,
                                &relationship.id,
                                file_path_set,
                    ...
                    crate::parts::slide_part::RELATIONSHIP_TYPE => {
                        ...
                        slide_part = Some(
                            Box::new(crate::parts::slide_part::SlidePart::new_from_archive(
                                &child_parent_path,
                                &target_path,
                                &relationship.id,
                                file_path_set,
    ...
    pub(crate) fn save_zip(
        ...
        let notes_slide_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../notesSlides"),
        );
        if !notes_slide_part_dir_path.is_empty()
            && !entry_set.contains(&notes_slide_part_dir_path)
        {
            zip.add_directory(
                &notes_slide_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(notes_slide_part_dir_path);
        }
        ...
        if let Some(slide_part) = &self.slide_part {
