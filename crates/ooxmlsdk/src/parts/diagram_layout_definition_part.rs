...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/diagramLayout";
...
pub struct DiagramLayoutDefinitionPart {
    ...
    pub root_element: crate::schemas::schemas_openxmlformats_org_drawingml_2006_diagram::LayoutDefinition,
...
impl DiagramLayoutDefinitionPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "../graphics/");
        ...
        let diagram_layout_definition_part_rels_path = crate::common::resolve_zip_file_path(
            &format!("{}_rels/{}.rels", child_parent_path, part_target_str),
        );
        let relationships = if let Some(file_path) = file_path_set
            .get(&diagram_layout_definition_part_rels_path)
        {
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_drawingml_2006_diagram::LayoutDefinition::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let diagram_layout_definition_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../graphics"),
        );
        if !diagram_layout_definition_part_dir_path.is_empty()
            && !entry_set.contains(&diagram_layout_definition_part_dir_path)
        {
            zip.add_directory(
                &diagram_layout_definition_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(diagram_layout_definition_part_dir_path);
        }
