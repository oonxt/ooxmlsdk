...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2011/relationships/webextensiontaskpanes";
...
pub struct WebExTaskpanesPart {
    ...
    pub root_element: crate::schemas::schemas_microsoft_com_office_webextensions_taskpanes_2010_11::Taskpanes,
...
impl WebExTaskpanesPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "../webextensions/");
        ...
        let web_ex_taskpanes_part_rels_path = crate::common::resolve_zip_file_path(
            &format!("{}_rels/{}.rels", child_parent_path, part_target_str),
        );
        let relationships = if let Some(file_path) = file_path_set
            .get(&web_ex_taskpanes_part_rels_path)
        {
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_webextensions_taskpanes_2010_11::Taskpanes::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let web_ex_taskpanes_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../webextensions"),
        );
        if !web_ex_taskpanes_part_dir_path.is_empty()
            && !entry_set.contains(&web_ex_taskpanes_part_dir_path)
        {
            zip.add_directory(
                &web_ex_taskpanes_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(web_ex_taskpanes_part_dir_path);
        }
