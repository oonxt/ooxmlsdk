...
pub struct MainDocumentPart {
    ...
    pub glossary_document_part: Option<
...
impl MainDocumentPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "word/");
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_wordprocessingml_2006_main::Document::from_str(
        ...
        let mut glossary_document_part: Option<
            crate::parts::glossary_document_part::GlossaryDocumentPart,
        > = None;
        ...
        if let Some(relationships) = &relationships {
            for relationship in &relationships.relationship {
                ...
                match relationship.r#type.as_str() {
                    ...
                    crate::parts::glossary_document_part::RELATIONSHIP_TYPE => {
                        let target_path = crate::common::resolve_zip_file_path(
                            &format!("{}{}", child_parent_path, relationship.target),
                        );
                        glossary_document_part = Some(
                            crate::parts::glossary_document_part::GlossaryDocumentPart::new_from_archive(
                                &child_parent_path,
                                &target_path,
                                &relationship.id,
                                file_path_set,
    ...
    pub(crate) fn save_zip(
        ...
        let main_document_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "word"),
        );
        if !main_document_part_dir_path.is_empty()
            && !entry_set.contains(&main_document_part_dir_path)
        {
            zip.add_directory(
                &main_document_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(main_document_part_dir_path);
        }
        ...
        if let Some(glossary_document_part) = &self.glossary_document_part {
            glossary_document_part.save_zip(&child_parent_path, zip, entry_set)?;
        }
