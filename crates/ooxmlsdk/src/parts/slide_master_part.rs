...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideMaster";
...
impl SlideMasterPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "slideMasters/");
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::SlideMaster::from_str(
        ...
        let mut slide_layout_parts: Vec<
            ...
            for relationship in &relationships.relationship {
                ...
                match relationship.r#type.as_str() {
                    ...
                    crate::parts::slide_layout_part::RELATIONSHIP_TYPE => {
                        ...
                        let slide_layout_part = crate::parts::slide_layout_part::SlideLayoutPart::new_from_archive(
                            &child_parent_path,
                            &target_path,
                            &relationship.id,
                            file_path_set,
                        ...
                        slide_layout_parts.push(slide_layout_part);
                    }
    ...
    pub(crate) fn save_zip(
        ...
        let slide_master_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "slideMasters"),
        );
        if !slide_master_part_dir_path.is_empty()
            && !entry_set.contains(&slide_master_part_dir_path)
        {
            zip.add_directory(
                &slide_master_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(slide_master_part_dir_path);
        }
        ...
        for slide_layout_part in &self.slide_layout_parts {
