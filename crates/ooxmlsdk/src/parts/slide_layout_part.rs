...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout";
...
pub struct SlideLayoutPart {
    ...
    pub slide_master_part: Option<crate::parts::slide_master_part::SlideMasterPart>,
...
impl SlideLayoutPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "../slideLayouts/");
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::SlideLayout::from_str(
        ...
        let mut slide_master_part: Option<
            ...
            for relationship in &relationships.relationship {
                ...
                match relationship.r#type.as_str() {
                    ...
                    crate::parts::slide_master_part::RELATIONSHIP_TYPE => {
                        ...
                        slide_master_part = Some(
                            crate::parts::slide_master_part::SlideMasterPart::new_from_archive(
                                &child_parent_path,
                                &target_path,
                                &relationship.id,
                                file_path_set,
    ...
    pub(crate) fn save_zip(
        ...
        let slide_layout_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../slideLayouts"),
        );
        if !slide_layout_part_dir_path.is_empty()
            && !entry_set.contains(&slide_layout_part_dir_path)
        {
            zip.add_directory(
                &slide_layout_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(slide_layout_part_dir_path);
        }
        ...
        if let Some(slide_master_part) = &self.slide_master_part {
