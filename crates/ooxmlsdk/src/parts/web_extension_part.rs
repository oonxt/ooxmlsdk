...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2011/relationships/webextension";
...
pub struct WebExtensionPart {
    ...
    pub root_element: crate::schemas::schemas_microsoft_com_office_webextensions_webextension_2010_11::WebExtension,
...
impl WebExtensionPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_webextensions_webextension_2010_11::WebExtension::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let web_extension_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "../webextensions"),
        );
        if !web_extension_part_dir_path.is_empty()
            && !entry_set.contains(&web_extension_part_dir_path)
        {
            zip.add_directory(
                &web_extension_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(web_extension_part_dir_path);
        }
