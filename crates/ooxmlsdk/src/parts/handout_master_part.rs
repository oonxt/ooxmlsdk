...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/handoutMaster";
...
pub struct HandoutMasterPart {
    ...
    >,
    pub slide_part: Option<crate::parts::slide_part::SlidePart>,
}
impl HandoutMasterPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let child_parent_path = format!("{}{}", parent_path, "handoutMasters/");
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::HandoutMaster::from_str(
        ...
        let mut user_defined_tags_parts: Vec<
            crate::parts::user_defined_tags_part::UserDefinedTagsPart,
        > = vec![];
        let mut slide_part: Option<crate::parts::slide_part::SlidePart> = None;
            ...
            for relationship in &relationships.relationship {
                ...
                match relationship.r#type.as_str() {
                    ...
                    crate::parts::slide_part::RELATIONSHIP_TYPE => {
                        ...
                        slide_part = Some(
                            crate::parts::slide_part::SlidePart::new_from_archive(
                                &child_parent_path,
                                &target_path,
                                &relationship.id,
                                file_path_set,
    ...
    pub(crate) fn save_zip(
        ...
        let handout_master_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "handoutMasters"),
        );
        if !handout_master_part_dir_path.is_empty()
            && !entry_set.contains(&handout_master_part_dir_path)
        {
            zip.add_directory(
                &handout_master_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(handout_master_part_dir_path);
        }
