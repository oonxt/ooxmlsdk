...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/recipientData";
#[derive(Clone, Debug, Default)]
pub struct MailMergeRecipientDataPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_word_2006_wordml::MailMergeRecipients,
}
impl MailMergeRecipientDataPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_word_2006_wordml::MailMergeRecipients::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let mail_merge_recipient_data_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !mail_merge_recipient_data_part_dir_path.is_empty()
            && !entry_set.contains(&mail_merge_recipient_data_part_dir_path)
        {
            zip.add_directory(
                &mail_merge_recipient_data_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(mail_merge_recipient_data_part_dir_path);
        }
