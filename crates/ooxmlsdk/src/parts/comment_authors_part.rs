...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/commentAuthors";
#[derive(Clone, Debug, Default)]
pub struct CommentAuthorsPart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::CommentAuthorList,
}
impl CommentAuthorsPart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_openxmlformats_org_presentationml_2006_main::CommentAuthorList::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let comment_authors_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !comment_authors_part_dir_path.is_empty()
            && !entry_set.contains(&comment_authors_part_dir_path)
        {
            zip.add_directory(
                &comment_authors_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(comment_authors_part_dir_path);
        }
