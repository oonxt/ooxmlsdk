...
pub const RELATIONSHIP_TYPE: &str = "http://schemas.microsoft.com/office/2011/relationships/chartStyle";
#[derive(Clone, Debug, Default)]
pub struct ChartStylePart {
    pub r_id: String,
    pub inner_path: String,
    pub root_element: crate::schemas::schemas_microsoft_com_office_drawing_2012_chart_style::ChartStyle,
}
impl ChartStylePart {
    ...
    pub(crate) fn new_from_archive(
        ...
        let root_element = Some(
            crate::schemas::schemas_microsoft_com_office_drawing_2012_chart_style::ChartStyle::from_str(
    ...
    pub(crate) fn save_zip(
        ...
        let chart_style_part_dir_path = crate::common::resolve_zip_file_path(
            &format!("{}{}/", parent_path, "."),
        );
        if !chart_style_part_dir_path.is_empty()
            && !entry_set.contains(&chart_style_part_dir_path)
        {
            zip.add_directory(
                &chart_style_part_dir_path,
                zip::write::SimpleFileOptions::default(),
            )?;
            entry_set.insert(chart_style_part_dir_path);
        }
